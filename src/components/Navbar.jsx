...
const Navbar = () => {
    ...
    const links = <>
        ...
        {
            user && user?.email ? <NavLink to="/dashboard/myProfile"><li>My Profile</li></NavLink> : <NavLink to="/login"><li>Login</li></NavLink>
        }
    </>

    return (
        <div className="navbar bg-[#F4F1EC] shadow-lg fixed top-0 w-full z-50">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        tabIndex={0}
                        className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 text-[#3A3F00] *:p-1 w-52 font-semibold p-4 shadow">
                        {links}
                    </ul>
                </div>
            ...
            <div className="navbar-end">
                {user?.email ? <div className="dropdown dropdown-end">
                    <div tabIndex={0} role="button" className="rounded-full">
                        <img src={user?.photoURL && user.photoURL} className="w-12 h-12 rounded-full object-cover" alt="user" />
                    </div>
                    <div tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow text-center">
                        ...
                        <NavLink className={"my-2 text-[#3A3F00]"} to="/dashboard/myProfile"><li>Dashboard</li></NavLink>
